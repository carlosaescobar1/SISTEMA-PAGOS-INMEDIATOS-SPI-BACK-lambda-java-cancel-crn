...
public class RequestMapper {
    ...
    private Customer getCustomer(DynamoSpiDto dynamoSpiDto) {
        ...
        if (dynamoSpiDto.getCustType() != null && dynamoSpiDto.getCustType().equalsIgnoreCase(PersonTypeEnum.PJ.getValue())) {
        ...
        } else if (dynamoSpiDto.getCustType() != null && dynamoSpiDto.getCustType().equalsIgnoreCase(PersonTypeEnum.PN.getValue())) {
